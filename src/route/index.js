...
var footer = {
  social: {
    email: {
      text: 'kolodii@mail.com',
      href: 'mailto:kolodii@mail.com',
    },
    phone: {
      text: '+380670000123',
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        {
          name: 'Львівська Академічна Гімназія',
          isEnd: true,
        },
        {
          name: 'ЛНУ ім. Франка',
          ...
          projects: [
            {
              ...
              awards: [
                ...
                {
                  name: 'Preparing SEO optimizes pages. The automated process of getting data for the app from documents',
                },
              ],
              stackAmount: 3,
              awardAmount: 2,
